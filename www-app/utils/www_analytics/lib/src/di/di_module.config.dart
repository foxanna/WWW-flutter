...
import 'package:www_analytics/src/service/analytics.dart' as _i5;
import 'package:www_analytics/src/service/crash_wrapper.dart' as _i6;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i5.IAnalyticsService>(() => _i5.AnalyticsService(
          wrapper: gh<_i3.IFirebaseWrapper>(),
          crashService: gh<_i4.ICrashService>(),
        ));
    gh.lazySingleton<_i6.ICrashWrapper>(
        () => _i6.CrashWrapper(crashService: gh<_i4.ICrashService>()));
    return this;
  }
}
