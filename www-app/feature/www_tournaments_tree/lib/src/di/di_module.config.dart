...
import 'package:www_tournaments_tree/src/redux/middleware.dart' as _i8;
import 'package:www_tournaments_tree/src/redux/reducer.dart' as _i9;
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i3.ITournamentsTreeProvider>(
        () => _i3.TournamentsTreeProvider(
              loader: gh<_i4.ITournamentsTreeLoader>(),
              statusService: gh<_i5.ITournamentStatusService>(),
              cache: gh<_i6.ITournamentsTreeCache>(),
              crashWrapper: gh<_i7.ICrashWrapper>(),
            ));
    gh.factory<_i8.TournamentsTreeMiddleware>(() =>
        _i8.TournamentsTreeMiddleware(
            provider: gh<_i3.ITournamentsTreeProvider>()));
