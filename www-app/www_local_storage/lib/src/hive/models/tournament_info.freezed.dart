...
mixin _$TournamentInfoHiveModel {
  ...
  @JsonKey(ignore: true)
  $TournamentInfoHiveModelCopyWith<TournamentInfoHiveModel> get copyWith =>
...
class _$_TournamentInfoHiveModel implements _TournamentInfoHiveModel {
  ...
  @override
  String toString() {
    return 'TournamentInfoHiveModel(id: $id, id2: $id2, title: $title, questionsCount: $questionsCount, toursCount: $toursCount, description: $description, url: $url, editors: $editors, createdAt: $createdAt, playedAt: $playedAt)';
  }
