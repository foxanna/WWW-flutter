...
const searchTournamentsApiResponse3 = '''
...
<body class="layout-left-main not-admin not-logged-in not-front section-search page-search-tours-4-1-ce-sort_rel layout-fluid l-m-eq bicons32 picons lg-ru">
...
<div id="header" class="clearfix">
  <div id="top-elements">
          <div id="search-box"><form action="/search/tours/4.1%20ce/sort_rel?page=0"  accept-charset="UTF-8" method="post" id="search-theme-form">
...
<input type="hidden" name="form_build_id" id="form-FUZjq5blYRYxDz7wzAp92NAxWbQa8XDf6EgfNE30pVs" value="form-FUZjq5blYRYxDz7wzAp92NAxWbQa8XDf6EgfNE30pVs"  />
...
<div id="body_right">
  ...
  <div class="navleft"><ul class="links" id="subnavlist"><li class="menu-200 first"><a href="/user/login?destination=search%2Ftours%2F4.1+ce%2Fsort_rel%3Fpage%3D0" title="Log in, create new account or request new password." class="popups-form-reload">Войти</a></li>
...
<li ><a href="/search/node/4.1%20ce/sort_rel">Content</a></li>
...
<li ><a href="/search/unsorted">Необработанное</a></li>
                                    ...
                                    <form action="/search/tours/4.1%20ce/sort_rel?page=0"  accept-charset="UTF-8" method="post" id="chgk-db-search-tournaments-form">
<div><div class="form-item" id="edit-keys-wrapper">
 <label for="edit-keys">Ключевые слова для поиска турнира: </label>
 <input type="text" maxlength="100" name="keys" id="edit-keys" size="100" value="4.1 ce" class="form-text" />
</div>
...
<input type="hidden" name="form_build_id" id="form-1zzKuEuZDfUzFQqUY5wvdVYVeFMEZsa9fTvyL1wykVk" value="form-1zzKuEuZDfUzFQqUY5wvdVYVeFMEZsa9fTvyL1wykVk"  />
...
<div class="box">
  ...
  <dt class="title">
  <a href="/node/8282">Бужский гард-1</a>
</dt>
<dd>
      <p class="search-snippet"> ... Вид:
Ч

Тур: Тур <strong>1</strong>

Вопрос <strong>1</strong>:
Остатки древнеримской виллы близ ... .net/publ/stati/paskhalki_i_otsylki_v_deus_ex_mankind_devided/<strong>4</strong>-<strong>1</strong>-0-931

Автор: Константин ... анатомии доктора Тульпа".

Источники:
 <strong>1</strong>. https://scicenter.online/kriminalistika-scicenter ... </p>
    </dd>
</dl>
<p><a href="/search/unsorted/4.1%20ce">Ещё</a></p></div><dl class="search-results questions-results">
  <dt class="title">
