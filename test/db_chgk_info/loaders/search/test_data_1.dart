...
const searchTournamentsApiResponse1 = '''
...
<body class="layout-left-main not-admin not-logged-in not-front section-search page-search-tours-test_crab-from_1990-01-01-to_2020-05-08-sort_rel layout-fluid l-m-eq bicons32 picons lg-ru">
...
<div id="header" class="clearfix">
  <div id="top-elements">
          <div id="search-box"><form action="/search/tours/test_crab/from_1990-01-01/to_2020-05-08/sort_rel?page=0"  accept-charset="UTF-8" method="post" id="search-theme-form">
...
<input type="hidden" name="form_build_id" id="form-1oPt9FFv0A5uqKJqQDwSTzU_OiwElg-FJSoBE6u3b0A" value="form-1oPt9FFv0A5uqKJqQDwSTzU_OiwElg-FJSoBE6u3b0A"  />
...
<div id="body_right">
  ...
  <div class="navleft"><ul class="links" id="subnavlist"><li class="menu-200 first"><a href="/user/login?destination=search%2Ftours%2Ftest_crab%2Ffrom_1990-01-01%2Fto_2020-05-08%2Fsort_rel%3Fpage%3D0" title="Log in, create new account or request new password." class="popups-form-reload">Войти</a></li>
...
<li ><a href="/search/node/test_crab/from_1990-01-01/to_2020-05-08/sort_rel">Content</a></li>
...
<li ><a href="/search/unsorted">Необработанное</a></li>
                                    ...
                                    <form action="/search/tours/test_crab/from_1990-01-01/to_2020-05-08/sort_rel?page=0"  accept-charset="UTF-8" method="post" id="chgk-db-search-tournaments-form">
<div><div class="form-item" id="edit-keys-wrapper">
 <label for="edit-keys">Ключевые слова для поиска турнира: </label>
 <input type="text" maxlength="100" name="keys" id="edit-keys" size="100" value="test_crab" class="form-text" />
</div>
...
<input type="hidden" name="form_build_id" id="form-Gb5Tugab7NYMQ_E0Kuqj9q5wdOiZPPOdVYEZ8rQCOU0" value="form-Gb5Tugab7NYMQ_E0Kuqj9q5wdOiZPPOdVYEZ8rQCOU0"  />
<input type="hidden" name="form_id" id="edit-chgk-db-search-tournaments-form" value="chgk_db_search_tournaments_form"  />

</div></form>
<!-- box --> 
<div class="box">
  <h2 class="title">Результаты</h2>  <div class="content"><dl class="search-results questions-results">
  </dl>
</div>
</div>
<!-- /box --> 
